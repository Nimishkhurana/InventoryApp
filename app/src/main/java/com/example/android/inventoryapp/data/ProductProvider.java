...
public class ProductProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (price == null) {
            throw new IllegalArgumentException("Product price must be specified");
        }
        // If the qty is provided, check that it's greater than or equal to 0 kg
        Integer qty = values.getAsInteger(ProductEntry.COLUMN_QTY);
        if (qty != null && qty < 0) {
